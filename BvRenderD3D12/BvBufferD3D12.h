...
{
public:
	BvBufferD3D12(BvRenderDeviceD3D12* pDevice, const BufferDesc& bufferDesc, ComPtr<ID3D12Resource>& resource,
		ComPtr<D3D12MA::Allocation>& allocation, void* pMappedMemory = nullptr);
	~BvBufferD3D12();
