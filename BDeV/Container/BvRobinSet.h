...
public:
	...
	explicit BvRobinSet(const size_t capacity, IBvMemoryAllocator* pAllocator = nullptr); // Reserve
	BvRobinSet(std::initializer_list<KeyValue> list, IBvMemoryAllocator* pAllocator = nullptr); // Initializer List
