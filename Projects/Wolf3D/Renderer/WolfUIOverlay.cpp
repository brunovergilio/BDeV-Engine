...
void WolfUIOverlay::Initialize(IBvRenderDevice* pDevice, IBvCommandContext* pContext, IBvShaderCompiler* pCompiler)
{
	m_Device = pDevice;
	m_Context = pContext;
...
void WolfUIOverlay::SetupPipeline(Format swapChainFormat, Format depthFormat, u32 sampleCount)
{
	SetupPipeline(swapChainFormat, depthFormat, nullptr, 0, sampleCount);
}


void WolfUIOverlay::SetupPipeline(IBvRenderPass* pRenderPass, u32 subpassIndex, u32 sampleCount)
{
	SetupPipeline(Format::kUnknown, Format::kUnknown, pRenderPass, subpassIndex, sampleCount);
}


void WolfUIOverlay::SetupPipeline(Format swapChainFormat, Format depthFormat, IBvRenderPass* pRenderPass, u32 subpassIndex, u32 sampleCount)
{
...
bool WolfUIOverlay::Update(f32 dt, BvWindow* pWindow)
{
...
void WolfUIOverlay::Render(bool msaa)
{
...
void WolfUIOverlay::CreateVB(u64 size, u32 count)
{
	if (m_VB)
	{
...
void WolfUIOverlay::CreateIB(u64 size, u32 count)
{
	if (m_IB)
	{
