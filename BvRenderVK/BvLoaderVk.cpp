...
//{
//#define BV_VK_EXPORTED_FUNCTION(pfn)		PFN_##pfn pfn;
//#define BV_VK_GLOBAL_LEVEL_FUNCTION(pfn)	PFN_##pfn pfn;
//#define BV_VK_INSTANCE_LEVEL_FUNCTION(pfn)	PFN_##pfn pfn;
//
...
//
//
//#define BV_VK_EXPORTED_FUNCTION(pfn) pfn = m_DLL.GetProcAddress<PFN_##pfn>(#pfn); \
////if (!##pfn) \
////{ \
...
//
//
//#define BV_VK_GLOBAL_LEVEL_FUNCTION(pfn) pfn = (PFN_##pfn)vkGetInstanceProcAddr(nullptr, #pfn); \
////if (!##pfn) \
////{ \
////	BvAssert(0, "Failed to load function pointer for "#pfn); \
////}
//
//
//#define BV_VK_INSTANCE_LEVEL_FUNCTION(pfn) pfn = (PFN_##pfn)vkGetInstanceProcAddr(instance, #pfn); \
////if (!##pfn) \
////{ \
////	BvAssert(0, "Failed to load function pointer for "#pfn); \
////}
//
//
//#define BV_VK_DEVICE_LEVEL_FUNCTION(pfn) deviceFunctions.pfn = (PFN_##pfn)vkGetDeviceProcAddr(device, #pfn); \
...
//
//
//constexpr const char * const pVulkanDLLName = "vulkan-1.dll";
//
//
//BvLoaderVk::BvLoaderVk()
//	: m_DLL(pVulkanDLLName)
//{
//}
//
//
...
//
//
//void BvLoaderVk::LoadExportedFunctions()
//{
//	BV_VK_EXPORTED_FUNCTION(vkGetInstanceProcAddr);
//}
//
//
//void BvLoaderVk::LoadGlobalFunctions()
//{
//	BV_VK_GLOBAL_LEVEL_FUNCTION(vkCreateInstance);
//	BV_VK_GLOBAL_LEVEL_FUNCTION(vkEnumerateInstanceExtensionProperties);
//}
//
//
//void BvLoaderVk::LoadInstanceFunctions(VkInstance instance)
//{
//	BV_VK_INSTANCE_LEVEL_FUNCTION(vkEnumeratePhysicalDevices);
//	BV_VK_INSTANCE_LEVEL_FUNCTION(vkGetPhysicalDeviceProperties);
//	BV_VK_INSTANCE_LEVEL_FUNCTION(vkGetPhysicalDeviceFeatures);
...
//
//
//void BvLoaderVk::LoadDeviceFunctions(VkDevice device, DeviceFunctions & deviceFunctions)
//{
...
//	BV_VK_DEVICE_LEVEL_FUNCTION(vkCmdBeginRendering);
//	BV_VK_DEVICE_LEVEL_FUNCTION(vkCmdEndRendering);
